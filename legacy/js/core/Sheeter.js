(function () {
    ...
    alchemy.formula.add({
        ...
        overrides: {
             ...
             */
            save: function () {
                console.error('core.Sheeter.save is not implemented');
            },
             ...
             */
            saveAs: function () {
                console.error('core.Sheeter.saveAs is not implemented');
            },
